...
**PR Link:** https://github.com/BasedHardware/omi/pull/10111

**PR Description:**
Fixed omi issue #7478: custom summaries generated by apps were silently 
dropped from MCP responses because SimpleConversation in routers/mcp.py 
did not include the apps_results field. Added the field and wrote two 
passing unit tests.

**Status:** Awaiting review

**Maintainer Feedback:** None yet — PR submitted July 20, 2026.
